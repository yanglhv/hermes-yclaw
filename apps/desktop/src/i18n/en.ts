...
export const en: Translations = {
  ...
  boot: {
    ready: 'YClaw Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading YClaw settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting YClaw Desktop…'
    },
    errors: {
      backgroundExited: 'YClaw background process exited.',
      backgroundExitedDuringStartup: 'YClaw background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your YClaw backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update YClaw',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting YClaw Desktop.',
    ...
    native: {
      ...
      inputBody: 'YClaw is waiting for your response.',
      turnDoneTitle: 'YClaw finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to YClaw defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while YClaw is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'YClaw asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while YClaw was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let YClaw follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'YClaw checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading YClaw configuration...',
    ...
    gateway: {
      ...
      intro:
        'YClaw Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running YClaw backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private YClaw backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote YClaw backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'YClaw Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · YClaw ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. YClaw runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure YClaw desktop' },
    ...
    hermesActiveSessions: (version, count) => `YClaw ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@yclaw:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent YClaw environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. YClaw will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting YClaw...',
    placeholderReconnecting: 'Reconnecting to YClaw…',
    ...
    attachUrlDesc: 'YClaw will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: "This version of YClaw can't update itself from inside the app.",
    ...
    availableBody: 'A new version of YClaw is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected YClaw backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed YClaw from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'YClaw will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The YClaw updater will take over in its own window and reopen YClaw when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. YClaw reconnects automatically when it’s back.',
    applyingClose: 'YClaw will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'YClaw needs a one-time install',
    ...
    settingUpTitle: 'Setting up YClaw Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another YClaw CLI or desktop instance is running. Stop any running YClaw instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The YClaw installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with YClaw Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'YClaw is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting YClaw…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run YClaw',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point YClaw at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — YClaw connects automatically',
      loopback: 'Opens your browser to sign in — YClaw connects automatically',
    ...
    authorizeThere: 'Authorize YClaw there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize YClaw there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'YClaw inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. YClaw will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'YClaw is restarting...',
      askRestart: 'Ask YClaw to restart the server',
      lookingRestart: taskId => `YClaw is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'YClaw is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `YClaw finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'YClaw could not restart the server.',
      stillWorking:
        'YClaw is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'YClaw is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'YClaw gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). YClaw won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'YClaw needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'YClaw needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart YClaw Desktop to use Save Image.',
    restartToSaveImages: 'Restart YClaw Desktop to save images',

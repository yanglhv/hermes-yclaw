...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should YClaw look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} YClaw need to see?`,
    ...
    {
      headline: `What should ${label} YClaw tackle?`,
...
const WORDMARK = 'YCLAW AGENT'
const BRAND_COLOR = '#F04E23'
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[calc(100%-1rem)] font-['Collapse'] font-bold uppercase leading-[0.9] tracking-[0.08em] text-[color:var(--yclaw-brand)] mix-blend-plus-lighter dark:text-[color:var(--yclaw-brand)]"
          style={{ '--fit-min': '2.75rem', '--yclaw-brand': BRAND_COLOR } as CSSProperties}
        >
          <span>
            <span>{WORDMARK}</span>
          </span>

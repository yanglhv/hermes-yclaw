...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'YClaw gateway connection closed',
      connectErrorMessage: 'Could not connect to YClaw gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'YClaw gateway is not connected',
